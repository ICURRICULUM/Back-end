...
public class 컴공19BData {
    ...
    public 컴공19BData(MemberRepository memberRepository,
    ...
    public List<Course> getCoursesData() {
        return Arrays.asList(
            ...
            Course.builder().code("GEG3001").name("생활과 재테크").credit(3).build(),
            Course.builder().code("GED5002").name("생활 속 바이오 이야기").credit(3).build(),
            Course.builder().code("GED5007").name("첨단 바이오테크놀로지의 이해").credit(3).build(),
            Course.builder().code("GEE6005").name("요가와 명상").credit(1).build()
        );
    }
    ...
    public List<Take> getTakesData(Member member) {
        return Arrays.asList(
            ...
            Take.builder().category(Category.교양필수).majorType(주전공)
                ...
                .member(member).build(), // 프로네시스 세미나 Ⅰ: 가치형성과 진로탐색
            Take.builder().category(Category.교양필수).majorType(주전공)
            ...
            Take.builder().category(Category.교양선택).majorType(주전공)
                .course(courseRepository.findByCode("GEG3001").get())
                .member(member).build(), // 생활과 재테크
            Take.builder().category(Category.교양필수).majorType(주전공)
            ...
            Take.builder().category(Category.전공선택).majorType(주전공)
                .course(courseRepository.findByCode("CSE2103").get())
                .member(member).build(), // 어셈블리어
            Take.builder().category(Category.교양필수).majorType(주전공)
                .course(courseRepository.findByCode("GEB1114").get())
                .member(member).build(), // 크로스오버 3: 사회의 탐색
            Take.builder().category(Category.교양필수).majorType(주전공)
                .course(courseRepository.findByCode("GEB1202").get())
                .member(member).build(), // 실용영어 R/W

            // 2학년 2학기
            Take.builder().category(Category.교양필수).majorType(주전공)
                .course(courseRepository.findByCode("ACE2101").get())
                .member(member).build(), // 공업수학 1
            Take.builder().category(Category.전공필수).majorType(주전공)
            ...
            Take.builder().category(Category.핵심교양2).majorType(주전공)
                .course(courseRepository.findByCode("GEC2001").get())
                .member(member).build(), // 부와 빈곤의 글로벌 지도
            ...
            Take.builder().category(Category.전공선택).majorType(주전공)
                .course(courseRepository.findByCode("CSE4308").get())
                .member(member).build(), // 컴퓨터보안
            Take.builder().category(Category.핵심교양5).majorType(주전공)
                .course(courseRepository.findByCode("GED5002").get())
                .member(member).build(), // 생활 속 바이오이야기

            // 3학년 2학기
            Take.builder().category(Category.전공선택).majorType(주전공)
                .course(courseRepository.findByCode("CSE3209").get())
                .member(member).build(),
            Take.builder().category(Category.전공선택).majorType(주전공)
            ...
            Take.builder().category(Category.전공선택).majorType(주전공)
                ...
                .member(member).build(),
            Take.builder().category(Category.핵심교양5).majorType(주전공)
                .course(courseRepository.findByCode("GED5007").get())
                .member(member).build(),
            ...
            Take.builder().category(Category.전공선택).majorType(주전공)
                ...
                .member(member).build(),
            Take.builder().category(Category.전공선택).majorType(주전공)
                .course(courseRepository.findByCode("CSE4312").get())
                .member(member).build(),
            Take.builder().category(Category.전공선택).majorType(주전공)
                .course(courseRepository.findByCode("CSE4315").get())
                .member(member).build(),
            Take.builder().category(Category.핵심교양3).majorType(주전공)
                .course(courseRepository.findByCode("GED3018").get())
                .member(member).build(),
            Take.builder().category(Category.교양선택).majorType(주전공)
                .course(courseRepository.findByCode("GEE4011").get())
                .member(member).build(),
            ...
            Take.builder().category(Category.전공필수).majorType(주전공)
                ...
                .member(member).build(),
            Take.builder().category(Category.교양선택).majorType(주전공)
                .course(courseRepository.findByCode("GEE6005").get())
                .member(member).build()
