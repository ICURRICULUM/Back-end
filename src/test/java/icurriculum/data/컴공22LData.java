...
public class 컴공22LData {
    ...
    public 컴공22LData(MemberRepository memberRepository,
    ...
    public List<Take> getTakesData(Member member) {
        return Arrays.asList(
            ...
            Take.builder().category(Category.핵심교양2).majorType(주전공)
                .course(courseRepository.findByCode("GED2010").get())
                .member(member).build(), // 축제와 인간사회
            Take.builder().category(Category.핵심교양4).majorType(주전공)
                .course(courseRepository.findByCode("GED4006").get())
            ...
            Take.builder().category(Category.창의).majorType(주전공)
                .course(courseRepository.findByCode("GEE4005").get())
                .member(member).build(), // 경영전략과 스타트업
            ...
            Take.builder().category(Category.전공선택).majorType(주전공)
                .course(courseRepository.findByCode("CSE2113").get())
                .member(member).build(), // 오픈소스SW개론
            Take.builder().category(Category.전공선택).majorType(주전공)
                .course(courseRepository.findByCode("CSE3209").get())
                .member(member).build(), // 시스템 프로그래밍
            Take.builder().category(Category.전공선택).majorType(주전공)
                .course(courseRepository.findByCode("CSE3313").get())
                .member(member).build(), // 리눅스 프로그래밍
            Take.builder().category(Category.교양선택).majorType(주전공)
                .course(courseRepository.findByCode("GED3018").get())
                .member(member).build(), // 그래픽 디자인 이야기
            Take.builder().category(Category.창의).majorType(주전공)
            ...
            Take.builder().category(Category.교양선택).majorType(주전공)
                ...
                .member(member).build(), // 인공지능과 소프트웨어를 활용한 탄소중립
            Take.builder().category(Category.창의).majorType(주전공)
                .course(courseRepository.findByCode("GEE4026").get())
                .member(member).build(), // 성공하는 비즈니스 모델 개발
            Take.builder().category(Category.교양선택).majorType(주전공)
                .course(courseRepository.findByCode("GEE5018").get())
                .member(member).build() // 커리어 디자인
        );
    }
