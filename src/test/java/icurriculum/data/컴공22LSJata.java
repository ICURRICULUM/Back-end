...
public class 컴공22LSJata {
    ...
    public 컴공22LSJata(MemberRepository memberRepository,
    ...
    public List<Take> getTakesData(Member member) {
        return Arrays.asList(
            ...
            Take.builder().category(Category.핵심교양2).majorType(주전공)
                .course(courseRepository.findByCode("GED2004").get())
                .member(member).build(), // 서양철학 : 거인들의 어깨
            Take.builder().category(Category.교양필수).majorType(주전공)
            ...
            Take.builder().category(Category.교양선택).majorType(주전공)
                .course(courseRepository.findByCode("GEE3016").get())
                .member(member).build(), // 초급일본어
            Take.builder().category(Category.교양선택).majorType(주전공)
                .course(courseRepository.findByCode("GEE5017").get())
                .member(member).build(), // 품질의 차원
