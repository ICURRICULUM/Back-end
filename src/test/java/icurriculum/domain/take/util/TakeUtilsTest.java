...
class TakeUtilsTest {
    ...
    void getCoreTakes_ShouldReturnCoreTakesOnly() {
        ...
        assertThat(coreTakes).containsExactlyInAnyOrder(핵심교양1Take, 핵심교양2Take, 핵심교양3Take, 핵심교양4Take, 핵심교양5Take, 핵심교양6Take);
    }
    ...
    void getTakesByCategory_ShouldReturnTakesOfSpecificCategory() {
        ...
        assertThat(핵심교양Takes).containsExactlyInAnyOrder(핵심교양1Take, 핵심교양2Take, 핵심교양3Take, 핵심교양4Take, 핵심교양5Take, 핵심교양6Take);
    ...
    void calculateTotalCredit_ShouldReturnTotalCredits() {
        List<Take> takes = List.of(전공필수Take, 전공선택Take, 교양필수Take, 교양선택Take, SW_AITake, 창의Take, customTake);
    ...
    void calculateTotalCredit_WithSet_ShouldReturnTotalCredits() {
        // given
        Set<Take> takes = Set.of(전공필수Take, 전공선택Take, 교양필수Take, 교양선택Take, SW_AITake, 창의Take, customTake);
    ...
    void extractCodes_ShouldReturnSetOfCourseCodes() {
        ...
        assertThat(codes).containsExactlyInAnyOrder("CSE2112", "CSE3309", "GEB1112", "GEE5017", "GED6009", "GEE4010", "CSE9318");
    }
    ...
    void isTakenOrAlternativeTaken_ShouldReturnTrueIfCodeOrAlternativeIsTaken() {
        ...
        // when
        boolean isTaken = TakeUtils.isTakenOrAlternativeTaken("CSE2103", alternativeCodes, takenCodes);
