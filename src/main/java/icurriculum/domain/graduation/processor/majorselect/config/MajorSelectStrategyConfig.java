package icurriculum.domain.graduation.processor.majorselect.config;

import icurriculum.domain.department.DepartmentName;
import icurriculum.domain.graduation.processor.majorselect.strategy.CommonMajorSelectStrategy;
