package icurriculum.domain.graduation.processor.generalrequired.config;

import icurriculum.domain.department.DepartmentName;
import icurriculum.domain.graduation.processor.generalrequired.strategy.CommonGeneralRequiredStrategy;
